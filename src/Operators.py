...
logical_and = HFunction(3, Associativity.RIGHT, op_func.logical_and, 2, '&&')
...
notequal = HFunction(4, Associativity.NONE, op_func.not_equal, 2, '!=')

logical_or = HFunction(3, Associativity.RIGHT, op_func.logical_or, 2, '||')
...
returns = HFunction(2, Associativity.RIGHT, op_func.create_lambda, 2, '->', lazy=True)

where_clause = HFunction(2.6, Associativity.LEFT, op_func.where, 2, 'where', lazy=True)
...
shift_left = HFunction(5, Associativity.LEFT, op_func.shift_left, 2, '<<')

shift_right = HFunction(5, Associativity.LEFT, op_func.shift_right, 2, '>>')
...
increment_by = HFunction(2.5, Associativity.RIGHT, op_func.increment_by, 2,
                         '+=', lazy=True)

decrement_by = HFunction(2.5, Associativity.RIGHT, op_func.decrement_by, 2,
                         '-=', lazy=True)

multiply_by = HFunction(2.5, Associativity.RIGHT, op_func.multiply_by, 2, '*=',
                        lazy=True)

divide_by = HFunction(2.5, Associativity.RIGHT, op_func.divide_by, 2, '/=',
                      lazy=True)

raise_to = HFunction(2.5, Associativity.RIGHT, op_func.raise_to, 2, '^=',
                     lazy=True)
...
class Op:
    def __init__(self, name='', hfunc=None):
        self.name = name
        self.value = hfunc
